...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.clicked.connect(self.defaultLight)
        self.pushButton_3.setStyleSheet('background-color : rgb(220, 220, 220)')
    ...
    def defaultLight(self):
        ...
        default_g = 204
        default_b = 255
        default_light = self.bulb.set_rgb(default_r,default_g,default_b)
        self.horizontalSlider_2.setValue(default_r)
        self.horizontalSlider_3.setValue(default_g)
        self.horizontalSlider_4.setValue(default_b)
